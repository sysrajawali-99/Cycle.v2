  ...
  bankAccounts: [
    {
      id: 'bank-1',
      bankName: 'Bank Central Asia (BCA)',
      accountNumber: '541-0988-771',
      accountHolder: 'PT RAJAWALI CYCLE INDONESIA',
      ...
      isPrimary: true,
      status: 'Aktif',
      notes: 'Rekening utama penerimaan termin invoice & pelunasan tagihan klien PT Rajawali'
    },
    {
      id: 'bank-2',
      ...
      accountHolder: 'PT RAJAWALI CYCLE INDONESIA',
      role: 'Rekening Payroll',
      branch: 'KCP Plaza Mandiri Gatot Subroto',
      swiftCode: 'BMRIIDJA',
      coaAccountCode: '1121',
      coaAccountName: 'Bank Mandiri - Rek Payroll (987-654-3210)',
      isPrimary: false,
      status: 'Aktif',
      notes: 'Khusus penggajian karyawan, transfer upah manpower site, dan iuran BPJS'
    },
    {
      id: 'bank-3',
      bankName: 'Bank BNI',
      ...
      accountHolder: 'PT RAJAWALI CYCLE INDONESIA',
      role: 'Rekening Pembayaran Invoice',
      branch: 'KCU Jakarta Pusat',
      swiftCode: 'BNINIDJA',
      coaAccountCode: '1122',
      coaAccountName: 'Bank BNI - Rek Giro Operasional (1177888008)',
      isPrimary: false,
      status: 'Aktif',
      notes: 'Pembayaran tagihan invoice vendor chemical, supplier logistik & mesin cleaning'
    },
    {
      id: 'bank-4',
      bankName: 'Bank BRI (Persero)',
      accountNumber: '888-999-000',
      accountHolder: 'PT RAJAWALI CYCLE INDONESIA',
      role: 'Rekening Simpanan',
      branch: 'KC Sudirman Jakarta',
      swiftCode: 'BRINIDJA',
      coaAccountCode: '1110',
      coaAccountName: 'Kas Besar (Cash on Hand HQ)',
      isPrimary: false,
      status: 'Aktif',
      notes: 'Rekening penampungan simpanan cadangan kas likuiditas darurat'
    },
    {
      id: 'bank-5',
      bankName: 'Bank Syariah Indonesia (BSI)',
      accountNumber: '777-666-555',
      accountHolder: 'PT RAJAWALI CYCLE INDONESIA',
      role: 'Rekening Operasional',
      branch: 'KCP Kuningan Syariah',
      swiftCode: 'BSMDIDJA',
      coaAccountCode: '1130',
      coaAccountName: 'Kas Kecil (Petty Cash Operasional Site)',
      isPrimary: false,
      status: 'Aktif',
      notes: 'Operasional harian, transport supervisor lapangan, dan petty cash proyek'
    }
  ],
